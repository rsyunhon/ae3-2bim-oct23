...
class Ui_MainWindow(object):
    ...
    def crear_base(self):
        cursor = conn.cursor()
        cadena_sql = 'CREATE TABLE Empleado (nombre TEXT, sueldo INTEGER, pagoFinal float, iva float)'
        try:
    ...
    def guardar_informacion(self):
        ...
        cadena_sql = """INSERT INTO Empleado (nombre, sueldo, pagoFinal, iva) VALUES ('%s', %d, %f, %f);""" % \
    (nombre, sueldo, pgFinal, iva)
        # ejecutar el SQL
        cursor.execute(cadena_sql)
